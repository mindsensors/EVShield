 ...
 */
  dist.init( &evshield, SH_BAS1 );// Modified for EVShield: 2015-2-16 by Michael Giles
 ...
 */
  acurr = dist.getDist();
  sprintf (str, "DistNx: Distance mm:   %d", acurr);
  Serial.println(str);
/**  Displays Voltage
 */  
  rcurr = dist.getVolt();
  sprintf (str, "DistNx: Voltage:   %d",  rcurr);
  Serial.println(str);
/**  Displays Reference Current value
 */    
  refI = dist.getType();
  sprintf (str, "DistNx: SensorType:  %d",  refI);
  Serial.println(str);
